...
/*
it fail because of gas price 0 is not posible
...
it('lets a user transfer a star', async() => {
    ...
    await instance.createStar('Star for transfer', tokenId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), 'Lookup Star')
});